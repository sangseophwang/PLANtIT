      ...
      <div className="Third__Contents">
        ...
        <div className="Third__Text">
          ...
          <p>
            ...
            maiores similique odit! Aut excepturi quis quia fugiat? Lorem ipsum
            dolor sit amet consectetur adipisicing elit. Animi quos tempora quia
            dolore, accusamus error necessitatibus repellendus eum recusandae
          </p>
        </div>
      </div>
    </section>
